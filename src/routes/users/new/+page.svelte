...
<div class="text-center">
	<a class="link-hover italic" href="/login">
		<span class="hidden sm:inline">Already have an account?</span> Click here to
		<span class="font-bold">LOGIN</span> instead!
	</a>
</div>
<form on:submit={createUser} class="flex flex-col items-center mt-4 gap-4">
	...
	<div class="flex flex-col w-8/12 gap-3 mb-4 sm:gap-7 mt-5">
		...
		<button class="btn" on:click={() => goto('/')}>Back to Homepage</button>
	</div>
</form>
